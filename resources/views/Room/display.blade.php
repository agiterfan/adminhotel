...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Room Detail') }}</h1>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="No_Kamar">No Kamar<span class="small text-danger">*</span></label>
                                        <input type="text" id="No_Kamar" class="form-control" name="No_Kamar" placeholder="No Kamar" value="{{ old('No_Kamar') }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        {{-- <input type="text" id="Jenis_Kamar" class="form-control" name="Jenis_Kamar" placeholder="Jenis Kamar" value="{{ old('last_name', Auth::user()->last_name) }}"> --}}
                                    </div>
                                </div>
                            </div>
